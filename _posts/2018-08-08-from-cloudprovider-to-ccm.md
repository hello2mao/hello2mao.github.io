...
- [一、背景](#一背景)
    - [1.1 基于 Kubernetes 的容器云](#11-基于-kubernetes-的容器云)
    - [1.2 Cloud Provider 与云厂商](#12-cloud-provider-与云厂商)
    - [1.3 Cloud Provider 的重构之路](#13-cloud-provider-的重构之路)
- [二、Cloud Provider 解析](#二cloud-provider-解析)
    - [2.1 Cloud Provider 的作用](#21-cloud-provider-的作用)
        - [2.1.1 kube-controller-manager 依赖 Cloud Provider 相关部分](#211-kube-controller-manager-依赖-cloud-provider-相关部分)
        ...
        - [2.1.2 kubelet 依赖 Cloud Provider 相关部分](#212-kubelet-依赖-cloud-provider-相关部分)
        - [2.1.3 kube-apiserver 依赖 Cloud Provider 相关部分](#213-kube-apiserver-依赖-cloud-provider-相关部分)
    - [2.2 Cloud Provider 的设计](#22-cloud-provider-的设计)
        - [2.2.1 LoadBalancer()的接口设计](#221-loadbalancer的接口设计)
        - [2.2.2 Routes()的接口设计](#222-routes的接口设计)
- [三、从 Cloud Provider 到 Cloud Controller Manager](#三从-cloud-provider-到-cloud-controller-manager)
    - [3.1 kube-controller-manager 的重构策略](#31-kube-controller-manager-的重构策略)
    - [3.2 kube-apiserver 的重构策略](#32-kube-apiserver-的重构策略)
    - [3.3 kubelet 的重构策略](#33-kubelet-的重构策略)
- [四、Cloud Controller Manager 解析](#四cloud-controller-manager-解析)
    - [4.1 Cloud Controller Manager 架构](#41-cloud-controller-manager-架构)
    - [4.2 Cloud Controller Manager 实现举例](#42-cloud-controller-manager-实现举例)
- [五、部署使用 Cloud Controller Manager 实践](#五部署使用-cloud-controller-manager-实践)
    - [5.1 总体要求](#51-总体要求)
    - [5.2 k8s 相关组件的启动配置变化](#52-k8s-相关组件的启动配置变化)
        - [5.2.1 kube-controller-manager 启动配置变化](#521-kube-controller-manager-启动配置变化)
        - [5.2.2 kube-apiserver 启动配置变化](#522-kube-apiserver-启动配置变化)
        - [5.2.3 kubelet 启动配置变化](#523-kubelet-启动配置变化)
    - [5.3 启动 CCM 举例](#53-启动-ccm-举例)
        - [5.3.1 启用 initializers 并添加 InitializerConifguration](#531-启用-initializers-并添加-initializerconifguration)
        - [5.3.2 创建 CCM 的 RBAC](#532-创建-ccm-的-rbac)
        - [5.3.3 启动 CCM](#533-启动-ccm)
- [六、参考](#六参考)
